...
`;function Be(e){const t=Math.max(1,...e.map(e=>e.value));return K`
  ...
  `}(v):V}
    ...
    `}};Ci.styles=[Oe,Pe],e([me()],Ci.prototype,"_config",void 0),Ci=e([he("librus-week-summary-card")],Ci);const Si=new Set(["unknown","unavailable",""]);let Di=class extends Le{static getConfigElement(){return Ae()}static getStubConfig(){return{type:"custom:librus-lucky-number-card"}}setConfig(e){this._config=e,this._configuredDeviceId=e.device_id}getCardSize(){return 2}render(){if(!this._config||!this.hass)return V;this._syncTheme();const e=this._resolveEntities();if("error"in e)return e.error;const{map:t}=e,i=this.hass,s=t.lucky_number?i.states[t.lucky_number]:void 0;if(!s)return this._message("mdi:dice-5-outline",$e(i,"empty.generic_error"));if(Si.has(s.state))return this._message("mdi:dice-5-outline",$e(i,"card.lucky_number.empty"));const a=s.attributes.is_today,r=s.attributes.day,n=s.attributes.is_yours,o=!1===a&&r,c=n?o?$e(i,"card.lucky_number.yours_for_date",{date:Ke(r,i.language)}):$e(i,"card.lucky_number.yours_today"):o?$e(i,"card.lucky_number.subtitle_for_date",{date:Ke(r,i.language)}):$e(i,"card.lucky_number.subtitle");return K`
      <ha-card
